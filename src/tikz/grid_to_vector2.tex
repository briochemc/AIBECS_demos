...
\begin{tikzpicture}
    ...
    dimy=2,%
    dimz=2,%
    front/.style={draw=blue!75!black,fill=julia_blue!25!white},%
    right/.style={draw=blue!25!black,fill=julia_blue!75!white},%
    top/.style={draw=blue!50!black,fill=julia_blue!50!white},%
    anglex=-7,%
    angley=90,%
    anglez=221.5,%
    scalex=1,%
